...
def trainValidation(train_x, train_y, n_epochs):
    ...
    ax.plot(epochs, best_CROSS_val, 'r', label='alor da Função de Perda (Cross-Entropy) Validação')
...
def trainTest(x_train, y_train, x_test, y_test, parameters, n_epochs):
