...
class LogisticRegressionClass:
    ...
    def train_validation(self, train_x, train_y, max_iter=100):
        ...
        precision = precision_score(train_y, ypred, average='micro')
        f1 = f1_score(train_y, ypred, average='micro')
    ...
    def test(self, test_x, test_y):
        ...
        precision = precision_score(test_y, ypred, average='micro')
        f1 = f1_score(test_y, ypred, average='micro')
        ...
        plt.savefig("./gráficos/LR/confusionMatrixTest.png")
